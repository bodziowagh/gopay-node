...
var Subscriptions = function (_CRUDResource_1$CRUDR) {
    ...
    Subscriptions.prototype.list = function list(data, callback, storeId) {
    ...
    Subscriptions.prototype.delete = function _delete(storeId, id, data, callback) {
        return this._deleteRoute()(data, callback, ["storeId", "id"], storeId, id);
    };

    Subscriptions.prototype.charges = function charges(storeId, id, data, callback) {
